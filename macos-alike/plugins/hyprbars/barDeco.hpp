...
class CHyprBar : public IHyprWindowDecoration {
  ...
  private:
    ...
    // handle release events; IS_LEFT_BUTTON should be true for left button releases
    bool doButtonRelease(Config::INTEGER barPadding, Config::INTEGER barButtonPadding, Config::INTEGER barHeight, Vector2D COORDS, bool BUTTONSRIGHT, bool IS_LEFT_BUTTON);
    ...
    int    m_pressedButtonIndex = -1; // -1 = none
    Vector2D m_pressedButtonPos;
