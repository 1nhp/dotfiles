...
### Features
- Working menu bar
- Dock (Limited applicaitons can only be added in a config file not all apps work well with this more information in the wiki)
...
Check the wiki for more information with configuring the dock and the shell
